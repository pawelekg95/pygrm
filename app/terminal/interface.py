...
class Interface:
    ...
    def __init__(self, github_client: GithubClient = None):
        ...
        self.option_mapping = {
            ...
            'stop': Command('Stop GitHub runner', stop_runner.StopCommand(self.github_client.user).perform),
            'start': Command('Start GitHub runner', start_runner.StartCommand(self.github_client.user).perform),
